...
- Briefly discuss the assumptions of each method you use
- Be concise
- Limit your total number of tables/figures to max 5
- Present both adjusted and unadjusted results

5. Compare results between the different approaches - Becca
6. Discuss the results - Armelle
